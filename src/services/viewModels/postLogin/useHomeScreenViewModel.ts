  ...
  const [products, setProducts] = useState<ProductResponse[]>([
    {
      useBy: 1673905293,
      items: [
        {id: 1, name: 'Apples', price: 2.50, categoryId: 3, useBy: 1674310405},
      ],
    },
    {
      useBy: 1673998093,
      items: [
        {id: 5, name: 'Aaaaaa', price: 12.20, categoryId: 2, useBy: 1674310405},
        {id: 6, name: 'Bbbbbb', price: 2.50, categoryId: 1, useBy: 1674310405},
